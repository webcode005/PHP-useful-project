...
<table class="table table-bordered">
				...
				<tbody>
						...
						$menulistqry="SELECT sub_menu.*,menu.menu_name,department.department_name from sub_menu inner join menu on menu.menu_id=sub_menu.menu_id inner join department on department.department_id=sub_menu.submenu_department
